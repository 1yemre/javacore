...
public class _13_1_MethodIsNotReturn {
    ...
    public  void metotReturnsuzParametresiz(){
        System.out.println("method  Returnsuz Parametresiz.");
    }
    ...
    public static void main(String[] args) {
        ...
        _13_1_MethodIsNotReturn.metotReturnsuzParametreli("Emre");
        _13_1_MethodIsNotReturn.metotReturnsuzParametreli("Emre","Yenen");
